...
L&#39;utilizzo di agenti di IA per l&#39;esecuzione di _processi agente_ comporta l&#39;utilizzo di crediti di IA. Ulteriori informazioni sui processi agente e sui crediti IA in [Processi agente e consumo credito IA](https://experienceleague.adobe.com/it/docs/core-services/interface/features/ai-credit-consumption).
...
| [Agente esperienza marchio](https://experienceleague.adobe.com/it/docs/experience-manager-cloud-service/content/ai-in-aem/agents/brand-experience/overview) | <ul><li>Accelera la migrazione e la modernizzazione delle esperienze digitali attraverso la ristrutturazione, l’arricchimento e la convalida automatici dei siti esistenti, in modo che i team possano passare più rapidamente a esperienze moderne e pronte per l’intelligenza artificiale, con meno rischi e sforzi manuali.</li><li>Consente di creare e aggiornare grandi volumi di esperienze, riducendo notevolmente il lavoro manuale e il tempo di ciclo, in modo che i team possano spostarsi più velocemente senza compromettere la qualità o l&#39;uniformità.</li><li>Velocizza la creazione di moduli ottimizzati per il marchio generando, strutturando e convalidando automaticamente le esperienze dei moduli, consentendo ai team di avviare più rapidamente e acquisire dati di qualità superiore con il minimo sforzo manuale.</li><li>Aiuta gli sviluppatori e gli amministratori tecnici di AEM CS a risolvere i problemi di installazione nella pipeline di Cloud Manager analizzando la causa principale e suggerendo correzioni.</li></ul> | <ul><li>Cloud Service Adobe Experience Manager Sites (modernizzazione dell’esperienza)</li></ul><ul><li>Adobe Experience Manager Sites (Experience Production)</li></ul><ul><li>Adobe Experience Manager Forms (creazione di moduli)</li></ul><ul><li>Tutte le applicazioni Adobe Experience Manager basate su cloud (supporto allo sviluppo)</li></ul> |
| [Brand Governance Agent](https://experienceleague.adobe.com/it/docs/experience-manager-cloud-service/content/ai-in-aem/agents/governance/overview) | <ul><li>Garantire l&#39;integrità e la conformità dei marchi grazie a controlli, autorizzazioni e funzionalità di intelligence automatizzati per supportare DRM con la governance in tempo reale.</li> | <ul><li>Adobe Experience Manager Assets</li><li>Adobe Experience Manager Sites (Politica sui marchi)</li></ul> |
| [Journey Agent](https://experienceleague.adobe.com/it/docs/experience-cloud-ai/experience-cloud-ai/agents/ajo-agent) | Possibilità per i team di creare, analizzare e ottimizzare rapidamente i percorsi multi-touch dei clienti su larga scala. | <ul><li>Adobe Journey Optimizer (edizioni B2B e B2C)</li></ul> |
| [Agente di supporto prodotti](https://experienceleague.adobe.com/it/docs/experience-cloud-ai/experience-cloud-ai/agents/product-support) | Risolvi i problemi di assistenza senza uscire dai tuoi flussi di lavoro, crea ticket di assistenza clienti e tieni traccia dell&#39;avanzamento del caso utilizzando l&#39;Assistente AI. | <ul><li>Real-Time CDP (versioni B2B, B2C e B2P)</li><li>Adobe Journey Optimizer (edizioni B2B e B2C)</li><li>Customer Journey Analytics (edizioni B2B e B2C)</li><li>Adobe Experience Manager</li></ul> |

## Applicazioni di Experience Cloud AI-first {#ai-first-apps}

Le applicazioni basate su intelligenza artificiale vengono create con Al generativo o agentico al centro. Utilizzano Al generativo o agentico per le attività chiave e le funzionalità agentiche sono già incluse nella licenza dell&#39;applicazione Al-first. Pertanto, non richiedono la licenza Experience Platform Agent Orchestrator.

Nella tabella seguente sono elencati gli agenti di Experience Platform disponibili come applicazioni Al-first. Sono abilitati concedendo in licenza queste applicazioni Al-first:

| Nome agente | Funzionalità | Applicazioni supportate |
| --- | ---------- | ---------- |
| [Agente di sperimentazione](https://experienceleague.adobe.com/it/docs/experimentation-accelerator/using/get-started/experiment-accelerator-security) | Automatizza, analizza e sintetizza le informazioni, in modo da identificare rapidamente esperimenti ad alto impatto e opportunità di crescita da un&#39;area di lavoro centralizzata, riducendo al contempo i processi manuali. | <ul><li>AJO Experimentation Accelerator</li></ul> |
