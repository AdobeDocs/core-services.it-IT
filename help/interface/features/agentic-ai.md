...
L&#39;utilizzo di agenti di IA per l&#39;esecuzione di _processi agente_ comporta l&#39;utilizzo di crediti di IA. Ulteriori informazioni sui processi agente e sui crediti IA in [Processi agente e consumo credito IA](https://experienceleague.adobe.com/en/docs/core-services/interface/features/ai-credit-consumption).
...
| [Journey Agent](https://experienceleague.adobe.com/en/docs/experience-cloud-ai/experience-cloud-ai/agents/ajo-agent) | Possibilità per i team di creare, analizzare e ottimizzare rapidamente i percorsi multi-touch dei clienti su larga scala. | <ul><li>Adobe Journey Optimizer (edizioni B2B e B2C)</li></ul> |
| [Agente di supporto prodotti](https://experienceleague.adobe.com/en/docs/experience-cloud-ai/experience-cloud-ai/agents/product-support) | Risolvi i problemi di assistenza senza uscire dai tuoi flussi di lavoro, crea ticket di assistenza clienti e tieni traccia dell&#39;avanzamento del caso utilizzando l&#39;Assistente AI. | <ul><li>Real-Time CDP (versioni B2B, B2C e B2P)</li><li>Adobe Journey Optimizer (edizioni B2B e B2C)</li><li>Customer Journey Analytics (edizioni B2B e B2C)</li><li>Adobe Experience Manager</li></ul> |
