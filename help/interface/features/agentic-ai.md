...
| Nome | Funzionalità | Applicazioni supportate |
| --- | ---------- | ---------- |
...
| [Journey Agent](https://experienceleague.adobe.com/en/docs/experience-cloud-ai/experience-cloud-ai/agents/ajo-agent) | Consente ai team di creare, analizzare e ottimizzare rapidamente percorsi di clienti multi-touch su larga scala. | <ul><li>Adobe Journey Optimizer (edizioni B2B e B2C)</li></ul> |
...
| [Adobe Marketing Agent for Microsoft 365 Copilot](https://experienceleague.adobe.com/en/docs/experience-cloud-ai/experience-cloud-ai/agents/ama-ms) | Collega Experience Platform direttamente al Copilot Microsoft 365. È possibile porre domande in linguaggio naturale nelle applicazioni Microsoft 365, ad esempio Team, Word, Powerpoint ed Excel, per recuperare immediatamente informazioni di marketing da Experience Platform senza interrompere il flusso di lavoro. | <ul><li> Informazioni operative su Experience Platform</li><li>Approfondimenti dati Customer Journey Analytics</li><li> Agente Audience</li><li>Journey Agent</li></ul> |
