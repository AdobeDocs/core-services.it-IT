...
Adobe [!DNL Experience Platform] [Agent Orchestrator](https://experienceleague.adobe.com/it/docs/experience-cloud-ai/experience-cloud-ai/home) è la tecnologia centrale per la creazione e il coordinamento di agenti di intelligenza artificiale esperti in Adobe [!DNL Experience Cloud].

Puoi accedere agli agenti di intelligenza artificiale tramite:

* [App [!DNL Experience Cloud] esistenti](#existing-apps) (è necessaria una licenza per utilizzare un agente di IA)
* [AI-First [!DNL Experience Cloud] apps](#ai-first-apps) (gli agenti sono nativi dell&#39;applicazione)

## [!DNL Experience Cloud] app esistenti

Le app esistenti funzionano autonomamente, ma l’aggiunta di agenti di intelligenza artificiale offre maggiore potenza e impatto. Se disponi di una licenza per [!DNL Platform Agent Orchestrator], puoi utilizzare [!DNL Platform Agents] per le app a cui hai diritto.
...
Queste app sono create con l’intelligenza artificiale al centro. Utilizzano l’intelligenza artificiale generativa o agente per le attività chiave e gli agenti di intelligenza artificiale sono già inclusi nella licenza dell’applicazione senza richiedere il componente aggiuntivo Agent Orchestrator.

| Nome agente | Disponibilità | Funzionalità | Applicazioni supportate |
|---|----------|----------|----------|
| [Agente di sperimentazione](https://experienceleague.adobe.com/en/docs/journey-optimizer/using/content-management/content-experiment/experiment/experiment-accelerator-security) | Disponibile | Automatizza l’analisi per identificare esperimenti e opportunità di crescita. | <ul><li>AJO Experimentation Accelerator</li></ul> |
| [Agente di ottimizzazione LLM](https://experienceleague.adobe.com/it/docs/llm-optimizer/using/home) | Disponibile | Migliora visibilità, precisione e influenza negli ambienti di ricerca basati sull’intelligenza artificiale, fornisci informazioni sulla presenza del brand nelle risposte generate dall’intelligenza artificiale, offre consigli sui contenuti prescrittivi e automatizza le correzioni di ottimizzazione | <ul><li>Adobe LLM Optimizer</li></ul> |
| [Site Optimization Agent](https://experienceleague.adobe.com/it/docs/experience-manager-sites-optimizer/content/home) | Disponibile | Utilizza l’intelligenza artificiale generativa per trovare e lanciare miglioramenti al sito web che migliorano il traffico, il coinvolgimento e i risultati di business complessivi. | <ul><li>AEM Sites Optimizer</li></ul> |
