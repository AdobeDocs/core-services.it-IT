...
|------------------|-------------------------|------------------|---------------------------|
| [Adobe GenStudio for Performance Marketing](#gspm) | GenStudio for Performane Marketing è un’applicazione genAI. Aiuta i team creativi e di marketing a creare contenuti personalizzati sul brand. | Non applicabile | Sì |
| [Adobe Experience Manager Sites](#aem) | GenAI viene utilizzato in [Genera varianti](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/generative-ai/generate-variations-integrated-editor?lang=en) per creare varianti di contenuto in base all&#39;input. | Non applicabile | Sì |
| [Sites Optimizer](#aem) | GenAI consente di analizzare e migliorare le prestazioni e l’efficacia delle esperienze web. | Non applicabile | No |
...
| [[!DNL Campaign] Servizi cloud gestiti](#campaign-cs) | Non applicabile | Disponibile per Content Accelerator per generare automaticamente contenuti personalizzati, coinvolgenti ed efficaci in base agli obiettivi di marketing su canali diversi come e-mail, SMS e push | Sì |
...
| [[!DNL Real-Time CDP]](#rtcdp) | Non applicabile | Disponibile per la conoscenza del prodotto da Experience League. Offre inoltre informazioni operative (in versione beta). | No |
...
| [[!DNL Workfront]](#workfront) | GenAI viene utilizzato con [informazioni e suggerimenti in-app](https://experienceleague.adobe.com/en/docs/workfront/using/basics/ai-assistant/ai-assistant-overview?lang=en). | Non applicabile | Sì |
