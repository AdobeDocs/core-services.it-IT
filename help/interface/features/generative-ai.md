...
[!UICONTROL L&#39;Assistente AI] è uno strumento di intelligenza artificiale conversazionale supportato in molte applicazioni Experience Cloud. Utilizzala per acquisire rapidamente _conoscenze sul prodotto_ e _informazioni operative_, a seconda dell&#39;applicazione in uso.

* **Conoscenza del prodotto:** La conoscenza del prodotto si riferisce a concetti e argomenti basati sulla documentazione di Experience League. Utilizza ad esempio [prompt basati su obiettivi](https://experienceleague.adobe.com/it/docs/experience-platform/ai-assistant/home) per scoprire rapidamente Experience Platform. Tutte le risposte di Experience League sono verificabili e citate con collegamenti.
...
## Quali funzioni GenAI sono supportate? {#ai-roundup}
...
**Nota:** [!DNL Experience Platform Agents] sono descritti in [Agentic AI in Experience Cloud](agentic-ai.md).
...
| **Nome prodotto** | **Funzioni IA** | **Assistente IA** | **Compatibilità Firefly** |
|------------------|-------------------------|------------------|-------------------|
| **Adobe GenStudio for Performance Marketing** | GenStudio for Performance Marketing è un’applicazione genAI. Aiuta i team creativi e di marketing a creare contenuti personalizzati sul brand. [Ulteriori informazioni](https://experienceleague.adobe.com/it/docs/genstudio-for-performance-marketing/user-guide/home) | Non applicabile | Sì |
| **Adobe Experience Manager as a Cloud Service (AEM CS)** | L’intelligenza artificiale è disponibile in:<ul><li>[Genera varianti](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/generative-ai/generate-variations-integrated-editor) in **AEM Sites**</li><li>[GenAI](https://experienceleague.adobe.com/en/docs/experience-manager-sites-optimizer/content/opportunity-types/overview) in **Sites Optimizer**</li><li>[Content Hub](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/assets/content-hub/product-overview?lang=en) e [Tag avanzati](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/assets/manage/smart-tags?lang=en#ai-smart-tags) in **AEM Assets**</li></ul> [Ulteriori informazioni](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/generative-ai/generative-ai-in-aem) <br> | L’Assistente IA è disponibile per: <ul><li>Pagina panoramica di Experience Hub<li>Edge Delivery Services</li><li>Siti</li><li>Risorse</li><li>Moduli</li><li>Contenuti multimediali dinamici</li><li>Cloud Manager</li></ul> [Ulteriori informazioni](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/ai-assistant/ai-assistant-in-aem) | Sì |
| **Adobe Experience Manager 6.5** | | L’Assistente IA è disponibile per: <ul><li>Pagina panoramica di Experience Hub<li>Edge Delivery Services</li><li>Siti</li><li>Risorse</li><li>Moduli</li><li>Contenuti multimediali dinamici</li><li>Cloud Manager</li></ul> [Ulteriori informazioni](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/ai-assistant/ai-assistant-in-aem) | Sì |
| **Adobe Experience Manager 6.5 LTS** | | L’Assistente IA è disponibile per: <ul><li>Pagina panoramica di Experience Hub<li>Edge Delivery Services</li><li>Siti</li><li>Risorse</li><li>Moduli</li><li>Contenuti multimediali dinamici</li><li>Cloud Manager</li></ul> [Ulteriori informazioni](https://experienceleague.adobe.com/en/docs/experience-manager-65-lts/content/ai-assistant/ai-assistant-in-aem) | Sì |
| **Adobe Experience Platform** | | Disponibile per approfondimenti operativi e di prodotto. [Ulteriori informazioni](https://experienceleague.adobe.com/en/docs/experience-platform/ai-assistant/landing) | No |
| **Adobe Journey Optimizer** | | Disponibile per approfondimenti operativi e di prodotto. [Ulteriori informazioni](https://experienceleague.adobe.com/it/docs/journey-optimizer/using/get-started/ai-assistant) | No |
...
| **Adobe Journey Optimizer B2B edition** |  | Disponibile per fornire assistenza con la conoscenza del prodotto. [Ulteriori informazioni](https://experienceleague.adobe.com/en/docs/journey-optimizer-b2b/user/ai-assistant/ai-assistant-overview) | No |
| **[!DNL Campaign]servizi cloud gestiti** |  | Disponibile per Content Accelerator per generare automaticamente contenuti personalizzati, coinvolgenti ed efficaci in base agli obiettivi di marketing su canali quali e-mail, SMS e push. [Ulteriori informazioni](https://experienceleague.adobe.com/en/docs/campaign-web/v8/content/ai-assistant/generative-gs) | Sì |
| **[!DNL Customer Journey Analytics]** | L’intelligenza artificiale viene utilizzata con:<ul><li> [Didascalie intelligenti](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-workspace/visualizations/intelligent-captions?lang=en): per approfondimenti sulle visualizzazioni di Workspace più utilizzate.</li><li>[Content Analytics](https://experienceleague.adobe.com/en/docs/analytics-platform/using/content-analytics/report/report?lang=en#template): per assegnare automaticamente i metadati delle risorse.</li></ul> | Disponibile per:<ul><li>[Conoscenza del prodotto](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2c-overview/ai-assistant?lang=en) (Experience League)</li><li>[Agente di supporto del prodotto](agentic-ai.md) </li><li>[Data Insights Agent](agentic-ai.md)</li></ul> | No |
| **Real-Time CDP** |  | Disponibile per la conoscenza del prodotto da Experience League. Offre inoltre informazioni operative. [Ulteriori informazioni](https://experienceleague.adobe.com/it/docs/experience-platform/ai-assistant/home) | No |
| **[!DNL Marketo]** | IA è disponibile in E-mail Designer (con Firefly), [Dynamic Chat](https://experienceleague.adobe.com/en/docs/marketo/using/product-docs/demand-generation/dynamic-chat/generative-ai/overview?lang=en) e [webinar interattivi](https://experienceleague.adobe.com/en/docs/marketo/using/product-docs/demand-generation/events/interactive-webinars/gen-ai?lang=en). | Disponibile in Marketo Engage [E-mail Designer](https://experienceleague.adobe.com/en/docs/marketo/using/product-docs/email-marketing/email-designer/ai-assistant) | Sì |
| **[!DNL Workfront]** |  | Disponibile per informazioni e suggerimenti in-app. [Ulteriori informazioni](https://experienceleague.adobe.com/en/docs/workfront/using/basics/ai-assistant/ai-assistant-overview) | Sì |

## Come posso utilizzare l’intelligenza artificiale generativa in Experience Cloud? {#products}
