...
| **Adobe Journey Optimizer** | Non applicabile | Disponibile per approfondimenti operativi e di prodotto. [Ulteriori informazioni](https://experienceleague.adobe.com/it/docs/journey-optimizer/using/get-started/ai-assistant) | No |
...
| **Adobe Journey Optimizer B2B edition** | Non applicabile | Disponibile per fornire assistenza con la conoscenza del prodotto. [Ulteriori informazioni](https://experienceleague.adobe.com/en/docs/journey-optimizer-b2b/user/ai-assistant/ai-assistant-overview) | No |
| **[!DNL Campaign]servizi cloud gestiti** | Non applicabile | Disponibile per Content Accelerator per generare automaticamente contenuti personalizzati, coinvolgenti ed efficaci in base agli obiettivi di marketing su canali quali e-mail, SMS e push. [Ulteriori informazioni](https://experienceleague.adobe.com/en/docs/campaign-web/v8/content/ai-assistant/generative-gs) | Sì |
...
| **Real-Time CDP** | Non applicabile | Disponibile per la conoscenza del prodotto da Experience League. Offre inoltre informazioni operative. [Ulteriori informazioni](https://experienceleague.adobe.com/it/docs/experience-platform/ai-assistant/home) | No |
...
| **[!DNL Workfront]** | GenAI viene utilizzato con [informazioni e suggerimenti in-app](https://experienceleague.adobe.com/en/docs/workfront/using/basics/ai-assistant/ai-assistant-overview?lang=en). Ulteriori informazioni | Non applicabile | Sì |
