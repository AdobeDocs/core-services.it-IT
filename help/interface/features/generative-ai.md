...
* **Data Insights Agent:** [Data Insights Agent](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2c-overview/data-analysis-ai), accessibile dall&#39;Assistente di intelligenza artificiale in [!DNL Customer Journey Analytics], è un agente di conversazione di intelligenza artificiale generativo che risponde in modo rapido ed efficiente alle domande sui tuoi dati. Genera visualizzazioni rilevanti in [!UICONTROL Analysis Workspace] utilizzando i componenti della visualizzazione dati e i dati effettivi.
...
* [Agente di supporto del prodotto](https://experienceleague.adobe.com/en/docs/experience-platform/ai-assistant/new-features/customer-support) nell&#39;Assistente di IA
* [Data Insights Agent](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2c-overview/data-analysis-ai) nell&#39;Assistente IA
* [Didascalie intelligenti](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-workspace/visualizations/intelligent-captions) nelle visualizzazioni di Workspace
