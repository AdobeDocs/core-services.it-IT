...
* **Conoscenza del prodotto:** La conoscenza del prodotto si riferisce a concetti e argomenti basati sulla documentazione di Experience League. Ad esempio, scopri come creare [prompt efficaci basati su obiettivi](https://experienceleague.adobe.com/it/docs/experience-platform/ai-assistant/home) per ottenere il massimo da Experience Platform. Tutte le risposte di Experience League sono verificabili e citate con collegamenti.
...
>[!NOTE]
>
>Molte applicazioni Experience Cloud offrono _Assistente IA_ come nome di funzione (come descritto di seguito). Tuttavia, questa funzione richiama le informazioni solo per l’applicazione specifica in uso. Ad esempio, l’Assistente IA in AEM fornisce solo informazioni rilevanti e utili relative ad AEM.
...
## Quali funzioni di intelligenza artificiale sono supportate in Experience Cloud? {#ai-roundup}

Di seguito è riportato un elenco delle applicazioni Experience Cloud che utilizzano funzioni basate sull’intelligenza artificiale, Assistente IA o IA agente. È indicata la compatibilità con [Adobe Firefly](https://business.adobe.com/products/firefly-business/firefly-ai-approach.html).
