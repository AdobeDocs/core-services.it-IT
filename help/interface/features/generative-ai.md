...
| **Adobe Experience Manager 6.5 LTS** | | L’Assistente IA è disponibile per: <ul><li>Pagina panoramica di Experience Hub<li>Edge Delivery Services</li><li>Siti</li><li>Risorse</li><li>Moduli</li><li>Contenuti multimediali dinamici</li><li>Cloud Manager</li></ul> [Ulteriori informazioni](https://experienceleague.adobe.com/it/docs/experience-manager-65-lts/content/ai-assistant/ai-assistant-in-aem) |
...
| **Adobe Journey Optimizer B2B edition** | Non applicabile | Disponibile per fornire assistenza con la conoscenza del prodotto. [Ulteriori informazioni](https://experienceleague.adobe.com/it/docs/journey-optimizer-b2b/user/ai-assistant/ai-assistant-overview) | No |
...
| **[!DNL Workfront]** | GenAI viene utilizzato con [informazioni e suggerimenti in-app](https://experienceleague.adobe.com/it/docs/workfront/using/basics/ai-assistant/ai-assistant-overview?lang=en). Ulteriori informazioni | Non applicabile | Sì |
