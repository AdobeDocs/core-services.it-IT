...
| [Adobe Experience Manager Sites](#aem) | GenAI viene utilizzato in [Genera varianti](https://experienceleague.adobe.com/it/docs/experience-manager-cloud-service/content/generative-ai/generate-variations-integrated-editor?lang=en) per creare varianti di contenuto in base all&#39;input. | Non applicabile | Sì |
...
| [[!DNL Workfront]](#workfront) | GenAI viene utilizzato con [informazioni e suggerimenti in-app](https://experienceleague.adobe.com/it/docs/workfront/using/basics/ai-assistant/ai-assistant-overview?lang=en). | Non applicabile | Sì |
