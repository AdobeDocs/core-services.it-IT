...
Adobe Experience Platform centralizza e standardizza i dati e i contenuti nell'azienda. Product documentation is located on [Adobe.io](https://www.adobe.io/apis/experienceplatform/home/services.html).
...
| [Launch](activation/activation.md) | La raccolta di dati e l'attivazione della tecnologia per siti e app. Include:<ul><li>Experience Platrorm Launch (la più recente soluzione di gestione tag)</li><li>Dynamic Tag Management</li><li>Triggers</li></ul> |
