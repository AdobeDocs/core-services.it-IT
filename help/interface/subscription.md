---
description: Scopri le origini di dati della soluzione e la configurazione delle sottoscrizioni. Gli abbonamenti (o sottoscrizioni) consentono il flusso di dati Attributi del cliente tra Experience Cloud e altre soluzioni (Analytics e Target).
...
Scopri le origini di dati della soluzione e la configurazione delle sottoscrizioni. Gli abbonamenti consentono il flusso di dati Attributi del cliente tra Experience Cloud e altre soluzioni ([!DNL Analytics] e [!DNL Target]).
