...
description: Scopri come gestire la traduzione dei dati dei visitatori in segmentazione del pubblico, in Experience Cloud [!DNL Audience Library].
...
Il [!DNL Audience Library] visualizza i tipi di pubblico in Experience Cloud. I tipi di pubblico sono raccolte di visitatori (un elenco di [!DNL Experience Cloud] ID). Puoi gestire come tradurre i dati sui visitatori in segmentazione del pubblico. La creazione e la gestione dei tipi di pubblico è simile alla creazione e all’utilizzo di segmenti. Puoi anche condividere il segmento di pubblico con i prodotti e i servizi di [!DNL Experience Cloud].
...
* I tipi di pubblico in tempo reale provengono da tipi di pubblico Experience Cloud e sono valutati in tempo reale.
...
|--- |--- |
| Experience Cloud Audiences | Crea, gestisci e condividi tipi di pubblico in modo nativo tramite [[!DNL Audience Library]](audience-library.md). È possibile:<ul><li>Utilizzare tipi di pubblico in tempo reale tramite gli attributi di analisi non elaborati</li><li>Combinare tipi di pubblico per creare tipi di pubblico compositi, unendo dati storici e in tempo reale</li><li>Visualizzare graficamente le dimensioni stimate dei tipi di pubblico</li></ul><br>Per suggerimenti sul tipo di pubblico da creare, consulta [Opzioni di creazione del pubblico](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-16471.html?lang=it). |
| Analytics | Nella segmentazione, puoi creare un segmento, combinarlo con una suite di rapporti e quindi pubblicare il segmento come Experience Cloud. Quando si pubblica un segmento, questo viene visualizzato nel [!DNL Audience Library] nell&#39;Experience Cloud. (vedere [Pubblicare segmenti in un Experience Cloud](https://experienceleague.adobe.com/docs/analytics/components/segmentation/segmentation-workflow/seg-publish.html?lang=it) in [!DNL Analytics] per ulteriori informazioni.) Il pubblico è disponibile anche come pubblico di destinazione per un’esperienza di campagna fornita da [!DNL Adobe Target], e in [!DNL Audience Manager]. Dopo aver condiviso un pubblico da [!DNL Adobe Analytics], e selezionala per l’utilizzo in una campagna attiva, i profili visitatore che soddisfano i criteri di definizione del segmento per gli ultimi 90 giorni vengono inviati a [!UICONTROL Servizi per il pubblico]. Il limite per i tipi di pubblico condivisi è stato aumentato a 75. Tipi di pubblico condivisi con Experience Cloud da [!DNL Analytics] non può superare i 20 milioni di membri univoci. Inoltre, a causa della memorizzazione nella cache, sono necessarie 12 ore prima che l’eliminazione delle suite di rapporti di Analytics possa essere visibile nell’Experience Cloud. |
...
| [!DNL Target] | Il [servizio ID](https://experienceleague.adobe.com/docs/id-service/using/home.html?lang=it) unisce ID e dati dei visitatori in un singolo profilo actionable da utilizzare nelle applicazioni. Il [Pubblica su Experience Cloud](audience-library.md) Durante il processo di creazione dei segmenti in Adobe Analytics, la casella di controllo consente di rendere disponibile il segmento nella libreria dei tipi di pubblico personalizzati di Adobe Target. Un segmento creato in [!DNL Analytics] o [!DNL Audience Manager] può essere utilizzato per attività in [!DNL Target]. Ad esempio, puoi creare campagne sulla base delle metriche di conversione di [!DNL Analytics] e sui segmenti di pubblico creati in [!DNL Analytics]. |
| [!DNL Audience Manager] | I pubblici condivisi sono disponibili in [!DNL Audience Manager] segmentazione. Tutti i tipi di pubblico di Experience Cloud sono disponibili in modalità nativa in [!DNL Audience Manager], che prevede:<ul><li>Automazione incorporata riguardo il modo in cui vengono condivisi e utilizzati nei flussi di lavoro delle applicazioni</li><li>Destinazioni esterne</li><li>Modellazione lookalike</li></ul> |
...
| Origine | Identifica la posizione in cui è stato creato il pubblico.<ul><li>**Analytics:** Un segmento creato in Adobe Analytics, quindi [pubblicato su Experience Cloud](audience-library.md).</li><li>**Experience Cloud:** un nuovo pubblico [creato in Experience Cloud Audiences](audience-library.md).</li><li>**Audience Manager:** I tipi di pubblico creati con Audienci Manager vengono visualizzati automaticamente in Audiences di Experience Cloud.</li></ul> |
