...
| Aiuto con | Risorsa |
|--- |--- |
| Non riesci a trovare Pubblico? | Verifica di avere il provisioning. Consulta [Guida introduttiva: abilitare le applicazioni per i servizi core](core-services.md).<br>Fai clic [qui](https://adobe.allegiancetech.com/cgi-bin/qwebcorporate.dll?idx=X8SVES) per richiedere l’accesso ai servizi per Profili e Tipi di pubblico (modulo di provisioning integrazioni). |
