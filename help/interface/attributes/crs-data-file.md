...
Dovrai disporre dell&#39;accesso a CRM o a dati simili dal proprio enterprise. I dati che carichi in Experience Cloud devono essere [!DNL .csv] un file. Se caricate tramite FTP o sftp, caricate anche un [!DNL .fin] file.

Gli attributi del cliente sono progettati per gestire alcuni file al giorno. Per attenuare l&#39;eventualità che un numero elevato di file di piccole dimensioni ritarda l&#39;elaborazione, i file inviati entro 30 minuti di un batch precedente dalla stessa organizzazione vengono indirizzati a una coda di priorità inferiore.

<!-- <p>Articulate difference between this and SAINT. </p> -->

## Tipi di file consentiti e requisiti di denominazione {#section_6F64FA02ACCC4215B0862CB6A1821FBF}
...
## Requisiti per i file di dati attributo {#section_169FBF5B7BBA47CE825B7A330CF3FE98}
...
<table id="table_A9849CC9AA784763921DE057F0F61515"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_E157EE6F98914EADA0C103D1D1E705D3"> 
      <li id="li_84FBD455DD164A28AC16F4A5AB19E4B3">Il limite massimo di dimensione file per l'FTP è 4 GB per ogni caricamento. </li> 
      <li>Limite minimo di dimensione file per 10 MB per ogni caricamento. </li>
      <li>Potete caricare un file ogni mezz'ora. </li>
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Quando caricate i dati attributo del cliente, se avete diversi file da caricare in rapida successione e in particolare se i file sono grandi, accertatevi che il file precedente sia stato elaborato prima di caricare il file successivo. Puoi monitorare questa situazione selezionando quando il file precedente è stato spostato nella cartella elaborata o non elaborata all'interno dell'account FTP degli attributi del cliente. </p> <p> La suddivisione di un file di grandi dimensioni in file più piccoli e l'invio in rapida successione potrebbe rallentare l'elaborazione, a meno che non sia possibile assicurarsi che ogni file sia elaborato completamente prima di inviare l'oggetto successivo. </p> </td> 
  </tr> 
  <tr> 
