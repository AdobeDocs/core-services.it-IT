...
| È richiesta la migrazione al servizio Experience Cloud ID? | La migrazione dipende dalle applicazioni che utilizzi. <ul><li>Adobe Analytics: fortemente consigliata </li><li>Adobe Target: obbligatoria. </li></ul><br>L’utilizzo del servizio ID di Experience Cloud consente di utilizzare le funzionalità di Experience Cloud più recenti, tra cui pubblici in tempo reale, modernizzazione di Adobe Target, integrazione di Analytics e tracciamento heartbeat nei video. |
