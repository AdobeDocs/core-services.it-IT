...
| È richiesta la migrazione al servizio Experience Cloud ID? | La migrazione dipende dalle applicazioni che utilizzi. <ul><li>Adobe Analytics: fortemente consigliata </li><li>Adobe Target: obbligatoria. </li></ul><br>L&#39;utilizzo del servizio ID Experience Cloud consente di utilizzare le funzionalità di Experience Cloud più recenti, tra cui i tipi di pubblico in tempo reale, la modernizzazione di Adobe Target, l&#39;integrazione di Analytics e il tracciamento heartbeat nei video. |
