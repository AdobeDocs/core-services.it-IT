---
description: Scopri i requisiti dei file di dati e le diverse origini dati per il caricamento di  [!DNL Customer Attributes]  nell'Experience Cloud.
...
Requisiti dei file di dati e origini dati multiple per il caricamento di [!DNL Customer Attributes] in Experience Cloud.
...
<table id="table_A9849CC9AA784763921DE057F0F61515"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>In Experience Cloud, è possibile caricare centinaia di colonne .csv </span> di <span class="filepath"> nel servizio Attributi del cliente. Tuttavia, quando configuri le sottoscrizioni e selezioni gli attributi, si applicano i seguenti limiti a seconda delle applicazioni che possiedi: </p> <p> 
...
(Consulta [ID cliente e stati di autenticazione](https://experienceleague.adobe.com/docs/id-service/using/reference/authenticated-state.html) per ulteriori informazioni.)
