...
1. Avvia il desktop [!DNL Creative Cloud] (oppure passa alla pagina [!UICONTROL File Creative Cloud] in un browser) e cerca la richiesta.
...
1. Per accedere ai contenuti della cartella, fai clic su **[!UICONTROL Apri cartella]** (o **[!UICONTROL Visualizza sul Web]**).

   ![Visualizza sul Web](../../assets/creative_cloud_open_folder.png)
1. Continua con l’aggiunta di commenti sulla risorsa condivisa:

   In Creative Cloud puoi effettuare la selezione in un&#39;immagine, quindi fare clic su **[!UICONTROL Attività]** per aggiungere un commento all&#39;immagine. I commenti vengono sincronizzati sulle risorse in [!DNL Creative Cloud] e [!DNL CX Enterprise].
