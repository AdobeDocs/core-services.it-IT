...
1. Nella pagina Condividi su Creative Cloud cercare l&#39;utente, quindi fare clic su **[!UICONTROL Add]**.

   ![Aggiungi un utente Creative Cloud](../../assets/asset-share-cc-page.png)

1. Fai clic su **[!UICONTROL Share]**.
1. Avvia il desktop [!DNL Creative Cloud] (oppure passa alla pagina [!UICONTROL Creative Cloud Files] in un browser) e cerca la richiesta.

   ![Notifica di richiesta](../../assets/cc_share_request.png)
1. Apri la richiesta, quindi fai clic su **[!UICONTROL Accept]**.

   ![Accetta richiesta](../../assets/cc_share_accept.png)
1. Per accedere ai contenuti della cartella, fare clic su **[!UICONTROL Open Folder]** (o **[!UICONTROL View on Web]**).
...
1. Per annullare la condivisione di una cartella, fare clic su **[!UICONTROL Share Using Creative Cloud]** (come nel [Passaggio 3](share.md)), rimuovere gli utenti selezionando X, quindi fare clic su **[!UICONTROL Share]**.
