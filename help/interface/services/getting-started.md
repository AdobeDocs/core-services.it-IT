...
Gli utenti aggiunti al gruppo [!UICONTROL attributi cliente] possono visualizzare la voce di menu [!UICONTROL attributi cliente] sul lato sinistro di Experience Cloud.
