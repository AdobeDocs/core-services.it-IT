...
|--- |--- |
| [Nozioni di base su Admin Console](experience-cloud.md) | Scopri i passaggi iniziali da seguire per iniziare a utilizzare le soluzioni Experience Cloud. |
...
1. Nella pagina di destinazione, seleziona l’icona del selettore ![](assets/menu-icon.png) per accedere al menu a discesa.
   ...
   Le soluzioni e i servizi visualizzati in questo menu dipendono dai privilegi dell&#39;applicazione definiti dall&#39;[amministratore](admin-getting-started.md#topic_3FCB4099640647E3B2411ADBFCE81909).
