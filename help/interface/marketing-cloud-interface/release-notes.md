---
description: '"Funzioni più recenti, note sulla versione e problemi noti per i servizi Experience Cloud come Attributi del cliente, Tipi di pubblico e gestione degli utenti."'
