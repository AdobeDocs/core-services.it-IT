...
| **`s_ecid`** | 63115200 (2 anni) | ~ 45 byte | Contiene una copia di CX Enterprise ID (ECID/MID) nel formato `s_ecid=MCMID\|<ECID>`. Funge da backup di prima parte dell’ECID, principalmente per scenari CNAME (prime parti). |
