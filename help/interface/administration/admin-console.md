...
| Collegamento Aiuto | Descrizione |
| ------- | ------- |
| [Ripristina Adobe ID](https://helpx.adobe.com/account/individual/sign-in-and-security/security-and-recovery/cant-sign-in-to-adobe-account.html) | Esci, quindi fai clic su **[!UICONTROL Ottieni assistenza per l&#39;accesso]** > **[!UICONTROL Reimposta la password]**. |
