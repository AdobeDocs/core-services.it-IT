...
| Collegamento Aiuto | Descrizione |
| ------- | ------- |
| [Ripristina Adobe ID](https://helpx.adobe.com/it/manage-account/kb/account-password-sign-help.html) | Esci, quindi fai clic su **[!UICONTROL Ottieni assistenza per l&#39;accesso]** > **[!UICONTROL Reimposta la password]**. |
...
| [!DNL Pass] | [Get started with Account IQ](https://experienceleague.adobe.com/it/docs/pass/aiq-help/get-started) |
...
* [Ricerca Advertising, Social e Commerce](https://experienceleague.adobe.com/it/docs/advertising/search-social-commerce/new-ui/user-administration)
...
* [Adobe Pass](https://experienceleague.adobe.com/it/docs/pass/aiq-help/get-started)
