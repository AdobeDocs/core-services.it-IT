...
>[!IMPORTANT]
>
>La gestione degli utenti in Admin Console prevede l’utilizzo di nuovi termini, interfacce e modalità di navigazione. Le informazioni riportate di seguito descrivono questi nuovi aspetti e contengono collegamenti a ulteriori risorse di aiuto. Questi argomenti di aiuto integrano le informazioni contenute nella [Guida utente per l’amministrazione di Enterprise](https://helpx.adobe.com/it/enterprise/managing/user-guide.html) per tutti i prodotti cloud Adobe.
...
[Guida utente per amministratori](https://helpx.adobe.com/it/enterprise/using/users.html) di Creative Cloud e Document Cloud. Alcune informazioni sono correlate alla gestione degli utenti di Experience Cloud, ad esempio [la gestione dei tipi di identità](https://helpx.adobe.com/it/enterprise/help/identity.html).

[Effettua l’accesso e gestisci le impostazioni del tuo profilo](../admin-getting-started/getting-started-experience-cloud.md#topic_AC564B6795334DE39359ADD87F52F2E0) per definire password, organizzazioni e notifiche.

## Profili di prodotto e gruppi {#section_AB50558124D541CF80A0D3D76D35A4BF}

L’aggiunta dei profili di prodotto segna un cambiamento nel modo in cui vengono gestiti i prodotti e servizi delle singole soluzioni, precedentemente basato sull’uso dei gruppi. In Admin Console, le autorizzazioni sono ora basate sui profili di prodotto, ovvero gruppi di prodotti e servizi che puoi assegnare agli utenti.

In Analytics, ad esempio, puoi configurare una serie di strumenti di reporting, quali Analysis Workspace e Report Builder, insieme a suite di rapporti, metriche, dimensioni e così via. Per autorizzare gli utenti all’uso di un profilo di prodotto, non devi fare altro che aggiungerli al profilo in questione. Consulta [Assegnare le autorizzazioni di accesso Analytics a un profilo di prodotto](../admin-getting-started/admin-getting-started.md#task_040673FE3E3E429B9531FBCB8B6A4391).
...
Dopo la migrazione, gli utenti effettueranno l’accesso con il proprio Adobe ID (o Enterprise ID) e si autenticheranno nelle soluzioni e nei servizi Experience Cloud nella pagina Web [marketing.adobe.com](https://marketing.adobe.com/). Gli utenti che tenteranno di accedere con i metodi precedenti ([!DNL my.omniture.com] e [!DNL sc.omniture.com]) verranno reindirizzati a [!DNL marketing.adobe.com].

**Argomenti correlati**

[Migrazione degli ID utente di Analytics](https://marketing.adobe.com/resources/help/it_IT/experience-cloud/admin-console/analytics-migration/)
...
Un *gruppo di sicurezza* viene mostrato come profilo di prodotto.

Consulta [Gestione dei gruppi e degli utenti](https://helpx.adobe.com/it/campaign/standard/administration/using/managing-groups-and-users.html) per informazioni sui gruppi di protezione e sull’assegnazione di utenti a gruppi di sicurezza.
...
Per informazioni sulle autorizzazioni per gli utenti in Admin Console, consulta [Gestione utenti](https://marketing.adobe.com/resources/help/en_US/experience-cloud/launch/?f=user-management) e configura le opzioni specifiche di Launch, inclusi i diritti per i profili.
...
Consulta [Utenti e autorizzazioni](https://marketing.adobe.com/resources/help/en_US/dtm/?f=users) per informazioni su come invitare gli utenti in Dynamic Tag Management, assegnare i ruoli utente e aggiungere gli utenti ai gruppi.
...
Consulta [Amministrazione](https://marketing.adobe.com/resources/help/en_US/aam/?f=c_administration) nella guida di Audience Manager.
...
1. Accedi ad [Admin Console](https://adminconsole.adobe.com/it/enterprise), quindi fai clic su **[!UICONTROL Prodotti]** (oppure sul nome del tuo prodotto).
...
* La versione più recente di Internet Explorer di Microsoft (Microsoft [ha terminato il supporto](https://www.microsoft.com/it-it/WindowsForBusiness/End-of-IE-support) di Internet Explorer 8, 9 e 10. Di conseguenza, i problemi segnalati a fronte di tali versioni specifiche di Internet Explorer non verranno corretti da Adobe).
* Google Chrome
* Mozilla Firefox
* Apple Safari
...
* [Adobe Target](https://marketing.adobe.com/resources/help/it_IT/target/ov/?f=r_supported_browsers)
* [Adobe Audience Manager](https://marketing.adobe.com/resources/help/en_US/aam/?f=c_supported_browsers)
* [Adobe Campaign Standard](https://helpx.adobe.com/it/campaign/standard/start/using/compatible-browsers.html)
* [Adobe Campaign Classic](https://helpx.adobe.com/it/campaign/kb/compatibility-matrix.html)
