...
| ------- | ------- | ------- |
| 10 luglio 2026 | Supporto di CX Enterprise per Federated Guest Access | Se hai abilitato [Federated Guest Access](https://helpx.adobe.com/business/enterprise/using/federated-guest-access.html) per l&#39;autenticazione sicura degli utenti guest nel tuo dominio, CX Enterprise consente a tali utenti di passare da un account all&#39;altro. Il cambio di account è disponibile dal commutatore organizzazione in qualsiasi pagina di [CX Enterprise](https://experience.adobe.com). |
...
* Nel menu [!DNL CX Enterprise] **[!UICONTROL Aiuto]**, la ricerca dei contenuti è stata aggiornata per poter filtrare in base all’applicazione nei risultati di ricerca di [Experience League](https://experienceleague.adobe.com/?lang=it#home).
